...
class AppMainColor {
  static Map<int, Color> blueColor = {
    ...
    300: const Color.fromRGBO(25, 125, 255, .4),
    400: const Color.fromRGBO(25, 125, 255, .5),
    500: const Color.fromRGBO(25, 125, 255, .6),
    600: const Color.fromRGBO(25, 125, 255, .7),
    700: const Color.fromRGBO(25, 125, 255, .8),
    800: const Color.fromRGBO(25, 125, 255, .9),
  ...
  static const Color textColor =  Color(0xff4E5D78);
